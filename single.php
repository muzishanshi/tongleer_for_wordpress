  ...
  <div class="am-u-md-9 am-u-md-push-3">
    ...
    <section>
		...
		<div class="am-cf am-article" style="padding:10px;background-color:#fff;">
			...
			<div>
				<small>
					<a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ) ?>" rel="author"><?php echo get_the_author(); ?></a> 发布 | <?php echo timeago( get_gmt_from_date(get_the_time('Y-m-d G:i:s')) )?> | 评论数：<?php echo get_comments_number('0', '1', '%'); ?>
				</small>
			</div>
			<p>
				<?php
